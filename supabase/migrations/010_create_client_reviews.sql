...
-- This table stores reviews/testimonials from clients for projects
...
CREATE INDEX IF NOT EXISTS idx_client_reviews_category ON client_reviews(project_category);
...
-- Policy: Anyone can insert reviews (they'll be pending by default)
...
-- For now, any authenticated user can manage reviews
-- You can restrict this further later by adding a role check
